...
import { Avatar, PrimaryTableCol, TableRowData } from 'tdesign-vue-next';
...
const COLUMNS: PrimaryTableCol<TableRowData>[] = [
  {
    // @ts-ignore
    title: t('pages.adminUser.userIcon'),
  ...
  { title: t('pages.adminUser.userName'), colKey: 'Container.Game.Name', ellipsis: true, align: 'center' },
  // {
